...
func whenConfigValidated(cfg *config.Config) (*ValidationResult, error) {
	validator := NewConfigValidator()
	return validator.ValidateConfig(cfg), nil
}

func newBaseNixConfig(t *testing.T, safeMode bool) *config.Config {
	t.Helper()
...
func withGenerations(t *testing.T, cfg *config.Config, generations int) *config.Config {
	t.Helper()
...
func withRiskLevel(t *testing.T, cfg *config.Config, level shared.RiskLevelType) *config.Config {
	t.Helper()
...
func withOptimize(t *testing.T, cfg *config.Config, optimize bool) *config.Config {
	t.Helper()
...
func withEnabled(t *testing.T, cfg *config.Config, enabled bool) *config.Config {
	t.Helper()
				...
				Given: []BDDGiven{
					{
						...
						Setup: func(t *testing.T) (*config.Config, error) {
				...
				When: []BDDWhen{
					{
						...
						Action: func(cfg *config.Config) (*ValidationResult, error) {
							validator := NewConfigValidator()
							return validator.ValidateConfig(cfg), nil
						},
					},
