...
func (vm *ValidationMiddleware) ValidateAndLoadConfig(ctx context.Context) (*config.Config, error) {
...
func (vm *ValidationMiddleware) ValidateAndSaveConfig(ctx context.Context, cfg *config.Config) (*config.Config, error) {
...
func (vm *ValidationMiddleware) ValidateConfigChange(ctx context.Context, current, proposed *config.Config) *config.ConfigChangeResult {
...
func (vm *ValidationMiddleware) ValidateProfileOperation(ctx context.Context, profileName, operationName string, settings *shared.OperationSettings) *ProfileOperationResult {
	...
	tempOp := ConfigCleanupOperation{
		Name:        operationName,
		Description: "Validation operation",
		RiskLevel:   shared.RiskLow, // Default to low for validation
