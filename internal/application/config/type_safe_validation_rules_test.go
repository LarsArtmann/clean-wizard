...
func TestTypeSafeSchemaRules_DeepCopy(t *testing.T) {
	...
	original := &TypeSafeValidationRules{
		...
		MaxRiskLevel:          shared.RiskLevelHighType,
		BackupRequired:        shared.RiskLevelCriticalType,
	...
	copied.MaxRiskLevel = shared.RiskLevelLowType
	copied.BackupRequired = shared.RiskLevelMediumType
...
func TestTypeSafeSchemaRules_DeepCopyEmpty(t *testing.T) {
	...
	copied.MaxRiskLevel = shared.RiskLevelCriticalType
