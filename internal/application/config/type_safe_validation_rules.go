...
type TypeSafeValidationRules struct {
	...
	MaxRiskLevel   shared.RiskLevelType `json:"max_risk_level"`
	BackupRequired shared.RiskLevelType `json:"backup_required"`
}
...
func (tsvr *TypeSafeValidationRules) copyRiskLevel(level shared.RiskLevelType) shared.RiskLevelType {
	return level
}
