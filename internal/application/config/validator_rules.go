...
type ConfigValidationRules struct {
	...
	RequireSafeMode       shared.EnforcementLevelType `json:"require_safe_mode"`

	// Risk Constraints
	MaxRiskLevel   shared.RiskLevel `json:"max_risk_level"`
	BackupRequired shared.RiskLevel `json:"backup_required"`
}
...
func getDefaultValidationRules() *config.ConfigValidationRules {
	...
	return &ConfigValidationRules{
		...
		RequireSafeMode: shared.EnforcementLevelError,
